...
export default function Experience() {
  return (
    <section className="relative bg-gradient-to-br from-background via-gray-900 to-blue-900 text-white py-16 px-6 md:px-20 overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-center mb-14 relative z-10 gap-3">
        ...
        <h3 className=" text-5xl md:text-6xl font-extrabold text-grey">2021 - 2023</h3>
      </div>
